...
sap.ui.define([
	...
	"use strict";
	return Controller.extend("newloginnewlogin.controller.View3", {	
		onSubmit    : function()
		{
...
// 		onInit : function()
// 		{
// 			var url1 = "/sap/opu/odata/SAP/Z_YUKS_ODATA_SF_PROD_ORDER_SRV";
// 			var result1;
// 			var od1 = new sap.ui.model.odata.ODataModel(url1,true);
// 			od1.read("Z_YUKS_ODATA_SF_PROD_ORDERSet?$filter=OrderNum eq '0001'&$format=json",{
// 				context:null,
// 				urlParameter:null,
// 				async:false,
// 				success: function(oData, oResponse)
